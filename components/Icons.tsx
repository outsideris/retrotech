// Inline SVG icons from Font Awesome Free 6.7.2 (icons CC BY 4.0 — https://fontawesome.com/license/free).
// Inlined so the footer's few icons no longer pull the external Font Awesome kit
// (which loaded extra CSS + webfonts on every page). Sized to 1em and uses currentColor.
...
export function TwitterIcon({ className }: IconProps) {
  return (
    <Icon viewBox="0 0 512 512" className={className}>
...
export function GitHubIcon({ className }: IconProps) {
  return (
    <Icon viewBox="0 0 496 512" className={className}>
...
export function RssIcon({ className }: IconProps) {
  return (
    <Icon viewBox="0 0 448 512" className={className}>
