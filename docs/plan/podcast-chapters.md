...
> 관련: [DESIGN.md](../DESIGN.md)(온사이트 재생기 미제공 결정), [ARCHITECURE.md](../ARCHITECURE.md)(피드 챕터 반영 경로), [TODO.md](../TODO.md) Phase 8.
...
- 회차별 실제 챕터 타임스탬프 입력(저자 작업, [TODO.md](../TODO.md) Phase 8).
